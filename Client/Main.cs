...
namespace GTANetwork
{
    ...
    internal partial class Main : Script
    {
        ...
        public static readonly string GTANInstallDir = ((string)Registry.GetValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Rockstar Games\Grand Theft Auto V", "AppiMultiplayerInstallDir", null));
        ...
        public Main()
        {
            ...
            LogManager.RuntimeLog("\r\n>> [" + DateTime.Now + "] AMP Initialization.");
            ...
            MainMenuCamera.PointAt(new Vector3(-1426.307f, -792.0175f, 21.50556f));
