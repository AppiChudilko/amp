...
namespace GTANetwork
{
    internal partial class Main
    {
        ...
        private void HandleVehiclePacket(VehicleData fullData, bool purePacket)
        {
            ...
            if (fullData.DirtLevel != null) syncPed.DirtLevel = fullData.DirtLevel.Value;
            ...
            if (fullData.Flag != null)
            {
                ...
                syncPed.IsConvertible = (fullData.Flag.Value & (short)VehicleDataFlags.IsConvertible) != 0;
            }
            //LogManager.StreamerLog("DirtLevel.Steering: " + fullData.DirtLevel);
