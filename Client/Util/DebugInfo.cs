...
namespace GTANetwork.Util
{
    public class DebugInfo : Script
    {
        ...
        public static bool VehicleDebug = false;
        ...
        private void Draw(object sender, EventArgs e)
        {
            ...
            if (VehicleDebug && Game.Player.Character.IsInVehicle())
            {
                string output = "=======VEHICLE INFO=======\n";
                output += "HP: " + Game.Player.Character.CurrentVehicle.BodyHealth + "\n";
                output += "Speed: " + Game.Player.Character.CurrentVehicle.Speed + "\n";
                output += "SteeringAngle: " + Game.Player.Character.CurrentVehicle.SteeringAngle + "\n";
                output += "Pos: " + Game.Player.Character.CurrentVehicle.Position + "\n";
                output += "Rot: " + Game.Player.Character.CurrentVehicle.Rotation + "\n";
                output += "IsConvertible: " + Game.Player.Character.CurrentVehicle.IsConvertible + "\n";
                output += "DirtLevel: " + Game.Player.Character.CurrentVehicle.DirtLevel + "\n";
