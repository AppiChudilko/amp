...
namespace NativeUI
{
    ...
    public class UIMenu
    {
        ...
        public void GoUpOverflow()
        {
            ...
            Audio.PlaySound(AUDIO_UPDOWN, AUDIO_LIBRARY);
        ...
        public void GoLeft()
        {
            ...
            it.Index--;
            Audio.PlaySound(AUDIO_LEFTRIGHT, AUDIO_LIBRARY);
        ...
        public void SelectItem()
        {
            ...
            {
                Audio.PlaySound(AUDIO_ERROR, AUDIO_LIBRARY);
                return;
            }

            Audio.PlaySound(AUDIO_SELECT, AUDIO_LIBRARY);
        ...
        public void GoBack()
        {
            Audio.PlaySound(AUDIO_BACK, AUDIO_LIBRARY);
            Visible = false;
            if (ParentMenu != null)
            {
