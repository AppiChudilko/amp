...
namespace GTANetwork
{
    ...
    {
        public static string GTANFolder = (string)Registry.GetValue(@"HKEY_LOCAL_MACHINE\SOFTWARE\WOW6432Node\Rockstar Games\Grand Theft Auto V", "AppiMultiplayerInstallDir", null);
        ...
        public void Start(params string[] args)
        {
            ...
            */
            ...
            var GTANFolder = (string)Registry.GetValue(dictPath, "AppiMultiplayerInstallDir", null);
            if (GTANFolder != AppDomain.CurrentDomain.BaseDirectory)
            {
                try
                {
                    Registry.SetValue(dictPath, "AppiMultiplayerInstallDir", AppDomain.CurrentDomain.BaseDirectory);
                }
            ...
            {
                MessageBox.Show(splashScreen.SplashScreen, "GTA5 or the AMPLauncher is already running. Please close them before starting Appi Multiplayer.");
                return;
            }
            #endregion
